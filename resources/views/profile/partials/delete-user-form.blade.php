<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-[#FFD700]">
            {{ __('Una vez que tu cuenta sea eliminada, todos sus recursos y datos serán eliminados permanentemente. Antes de eliminar tu cuenta, por favor descarga cualquier dato o información que desees retener.') }}
        </p>
    </header>
